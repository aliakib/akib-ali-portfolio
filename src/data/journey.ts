...
export const journeyStages: JourneyStage[] = [
  {
    ...
    context: "Commissioned as a paid project by my trainer, Mr. Sakir, to build the complete technical foundation for a proposed educational institute. I architected and developed the application from scratch as the sole developer. Although Mr. Sakir later decided not to pursue the institute, the software application was fully architected, developed, and completed.",
    keyLearnings: [
